---
title: "海外參與者"
description: "海外參與者指南：入境、交通、付款、飲食與緊急聯絡方式。"
---
...
歡迎在第一天的 `8 Aug (Sat) 10:00-11:00` 參與 [(English) Getting Started with COSCUP: A First-timer’s Orientation](https://docs.google.com/document/d/1ZerJ-5QYcEJ5guhxtK-SBW2BA6RMHtVJnqNIWxRCz18/edit?tab=t.0#heading=h.c7x30ta9qw4x)，地點在 `310-2`。
...
- Invitation Letter：是否需要 COSCUP 邀請函。簽證與邀請函申請方式請參考：[簽證所需的邀請函申請指南](https://coscup.org/2026/participate/invitation-letter-guide)。
- Arrival Card：請事前填寫入境資料：[https://twac.immigration.gov.tw/](https://twac.immigration.gov.tw/)
- 航班、住宿、旅遊保險與緊急聯絡資訊。
- 臺灣當地網路、SIM 卡或 eSIM 方案。
- 臺灣電壓為 110V、頻率 60Hz，常見插座為 [Type A](<https://en.wikipedia.org/wiki/AC_power_plugs_and_sockets#NEMA_1-15_ungrounded_(Type_A)>) / [Type B](<https://en.wikipedia.org/wiki/AC_power_plugs_and_sockets#NEMA_5-15_grounded_(Type_B)>)。若您的設備不支援 110V 或插頭規格不同，請自行準備轉接頭或變壓器。
- 建議自備牙刷、拖鞋，以及刮鬍刀（如果需要）；飯店不一定會提供。
- 建議視個人需求投保旅遊保險、醫療保險或行李延誤相關保險。
- 如果你的旅行經驗比較少，建議先準備一張[緊急聯絡資訊](#local-contact-for-emergency)紙條，以備不時之需。
...
COSCUP 主要會場位於國立臺灣科技大學。前往會場、機場往返、市區大眾運輸與相關交通資訊，請參考：[交通資訊](https://coscup.org/2026/transportation)。
...
如果您需要遠端工作，臺灣有許多咖啡廳提供插座，也有不少對數位游牧與遠端工作者友善的咖啡廳。您也可以從[台灣數位游牧協會](https://dna.org.tw/en/home_en/)取得免費資訊，規劃適合工作的地點與城市。
...
除了 COSCUP 大會本身，臺灣平日也有許多開源社群聚會、技術小聚、讀書會與工作坊。您可以參考[大會周邊活動 Fringe Events](https://docs.google.com/document/d/1ZerJ-5QYcEJ5guhxtK-SBW2BA6RMHtVJnqNIWxRCz18/edit?tab=t.0)，或查看 [開源社群推廣目錄](https://hackmd.io/@SITCON/floss-community-list)。很多活動即使主要語言是中文，英文大多也可以溝通。

臺灣也有許多 hackerspace 與 maker space，可以參考：

- [Taipei Hackerspace](https://taipeihack.org/)
- [Maker Faire 臺灣的 Maker Space 介紹](https://taipei.makerfaire.com/about/maker-faire-%E8%87%BA%E7%81%A3%E7%9A%84maker-space/)
...
- 報名表單：[https://forms.gle/kZf79YNXrPwBJuLZ7](https://forms.gle/kZf79YNXrPwBJuLZ7)
- 建議您事前預約。

<h2 id="local-contact-for-emergency">緊急聯絡資訊 (Local Contact for Emergency)</h2>
