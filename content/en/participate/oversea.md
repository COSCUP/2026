...
You are welcome to join [(English) Getting Started with COSCUP: A First-timer's Orientation](https://docs.google.com/document/d/1ZerJ-5QYcEJ5guhxtK-SBW2BA6RMHtVJnqNIWxRCz18/edit?tab=t.0#heading=h.c7x30ta9qw4x) on the first day at `8 Aug (Sat) 10:00-11:00`. The location is `310-2`.
...
- Taiwan uses 110V / 60Hz electricity, and common outlets are [Type A](<https://en.wikipedia.org/wiki/AC_power_plugs_and_sockets#NEMA_1-15_ungrounded_(Type_A)>) / [Type B](<https://en.wikipedia.org/wiki/AC_power_plugs_and_sockets#NEMA_5-15_grounded_(Type_B)>). If your devices do not support 110V or use a different plug type, please bring your own adapter or voltage converter.
...
- If you have less travel experience, we recommend preparing a [Local Contact for Emergency](#local-contact-for-emergency) note just in case.
...
- [Student cafeteria information](https://github.com/COSCUP/NTUST-Foodlist)
...
<figure style="margin:16px 0;width:100%;max-width:none;">
  <iframe src="https://www.flickr.com/photos/coscup/54865886454/player/" width="100%" height="457" frameborder="0" allowfullscreen style="border:0;display:block;width:100%;max-width:none;"></iframe>
</figure>
...
If you need to work remotely, Taiwan has many cafes with power outlets, as well as many cafes friendly to digital nomads and remote workers. You can also get free information from the [Taiwan Digital Nomad Association](https://dna.org.tw/en/home_en/) to plan cities and locations suitable for work.
...
Besides COSCUP itself, Taiwan has many regular open source community meetups, technical gatherings, study groups, and workshops. You can refer to [Fringe Events](https://docs.google.com/document/d/1ZerJ-5QYcEJ5guhxtK-SBW2BA6RMHtVJnqNIWxRCz18/edit?tab=t.0), or check the [Open Source Community Promotion Directory](https://hackmd.io/@SITCON/floss-community-list). Even when the main language is Chinese, English communication is usually possible.

Taiwan also has many hackerspaces and maker spaces. Refer to:

- [Taipei Hackerspace](https://taipeihack.org/)
- [Maker Faire Taiwan's Maker Space Introduction](https://taipei.makerfaire.com/about/maker-faire-%E8%87%BA%E7%81%A3%E7%9A%84maker-space/)
...
- Registration form: [https://forms.gle/kZf79YNXrPwBJuLZ7](https://forms.gle/kZf79YNXrPwBJuLZ7)
...
內文裡面請寫現在時間，如果知道他的名字就寫上來他叫什麼名字，然後寫下目前發生的事情，以及你將他帶到哪一個地點。

請您指示給他你目前要採取的行動是：

- [ ] 由於我無法幫助你，我已經先連絡 COSCUP 了，然後我會帶你去附近的超商，他們應該稍後就會連絡你，請你稍微在超商等待一下。 / I cannot help you directly, so I have contacted COSCUP first. I will take you to a nearby convenience store. They should contact you later. Please wait at the convenience store for a while.
- [ ] 由於我無法幫助你，我可以帶你去警察局嗎？他們可以幫助你。 / I cannot help you directly. May I take you to a police station? They can help you.

如果您帶他到附近的便利商店，請他在超商等待，我們收到訊息後會嘗試聯絡超商。

十分感謝你的協助。

此紙條來自於 COSCUP 2026 - 開源人年會交流組（可經由開放文化基金會聯絡）。
